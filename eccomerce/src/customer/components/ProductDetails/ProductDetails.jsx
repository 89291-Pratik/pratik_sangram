...
export default function ProductDetails() {
  ...
  const { product: currentProduct, isLoading } = useAppSelector(state => state.products);
      ...
      <div className="pt-6">
        ...
        <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className='opacity-50 line-through'>₹{currentProduct?.price}</p>
            <p className='text-green-600 font-semibold'>{currentProduct?.discountPercent}% Off</p>
            </div>
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            ...
            <div>
              ...
              <div className="space-y-6">
                <p className="text-base text-gray-900">{currentProduct?.description || product.description}</p>
              </div>
            </div>
